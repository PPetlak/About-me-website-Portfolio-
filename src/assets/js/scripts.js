...
var typed = new Typed('#type', {
  strings: ["Witaj na mojej stronie. Mam na imię Patryk..."],
  typeSpeed:60,
  backSpeed: 50,
  showCursor: true,
  ...
  setTimeout(function() {
    ...
    $(".fade").animate({"opacity": "1"}, 2000, function(){
      $('.social').removeClass('invisible').addClass('animated flipInX');
    });
}, 5000);

/*ABOUT ME*/
$('.about-me').waypoint(function(dir) {
  $('.whoiam-img').removeClass('invisible').addClass('animated slideInRight');
}, {offset: 350});
$('.about-me').waypoint(function(dir) {
  $('.whatido-img').removeClass('invisible').addClass('animated slideInLeft');
}, {offset: 50});
$('.about-me').waypoint(function(dir) {
...
$('.img-hover').hover(function() {
  $('.img-hover').removeClass('invisible').addClass('.img-hover2')
});
